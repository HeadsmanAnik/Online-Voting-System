...
{
    public partial class cast_vote : System.Web.UI.Page
    {
        ...
        protected void btnsubmit_Click(object sender, EventArgs e)
        {
            ...
            cmd.Parameters.AddWithValue("@ofid", txtvoterid.Text);
            {
                ...
                if (reader.HasRows == false)
                {
                    ...
                    cmd1.Connection = con;
                    cmd1.CommandText = "insert into result1 (Of_id,vote_name,Candidate_Id,Candidate_name,Candidat_sign,Voter_id) values (@Of_id,@vote_name,@Candidate_Id,@Candidate_name,@Candidat_sign,@Voter_id)";
