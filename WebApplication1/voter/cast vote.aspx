<%@ Page Title="" Language="C#" MasterPageFile="~/voter/votersite.Master" AutoEventWireup="true" CodeBehind="cast vote.aspx.cs" Inherits="WebApplication1.voter.cast_vote" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container" style="background-position:center; height:auto; width:640px;background-color:rgba(7, 31, 61, 0.90)" >
        <div style="text-align:center; padding:4px; background-color:rgba(11, 10, 81, 0.66); height:auto;width:auto">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:mycon %>" SelectCommand="SELECT DISTINCT [of_id], [vote_name], [status] FROM [Creat_vote] WHERE ([status] IS NULL)"></asp:SqlDataSource>
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource2" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" Width="642px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Image sign" SortExpression="sign_pic">
                        ...
                        <ItemTemplate>
                            <asp:Image ID="Image1" runat="server" Height="45px"  ImageUrl='<%# Eval("sign_pic") %>' Width="45px" />
                        </ItemTemplate>
                    </asp:TemplateField>
            ...
            <br />
                ...
                <div>  <asp:Label ID="Label1" runat="server" CssClass="btn btn-info" ForeColor="Red" Text=""></asp:Label></div>
        </div>
                <strong style="color:White">Fill Up the Ballott</strong>

                <br />
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ForeColor="White" ErrorMessage="Please Select a Row" ControlToValidate="txtof_id"></asp:RequiredFieldValidator>
            <div>
            <table class="nav-justified;" style="color:rgba(255, 255, 255, 0.90); width:643px; height:auto;" border="1"  >
                ...
                <br />
               &nbsp &nbsp &nbsp      &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp   &nbsp &nbsp &nbsp   &nbsp &nbsp &nbsp    &nbsp &nbsp &nbsp    &nbsp &nbsp &nbsp <asp:Button ID="btnsubmit" CssClass="btn btn-warning" runat="server" Text="SUBMIT" Height="49px" Width="326px" OnClick="btnsubmit_Click" />
